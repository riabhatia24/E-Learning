  	...
  	<li><a href="#">Computer Science<span class="arrow">&#9660;</span></a>
        ...
        <li id="sem1" onclick="test(this)"><a href="#">Semester 1<span class="arrow">&#9660;</span></a>
        	<ul id="sem1det" style="display:none">
        		<li><a href="#">Applied Maths[2015,2016,2017]</a></li>
		<li><a href="#">Applied Physics[2015,2016,2017]</a></li>
	    <li><a href="#">EME[2015,2016,2017]</a></li>
	    <li><a href="#">ITC[2015,2016,2017]</a></li>
	     <li><a href="#">Applied Chemistry[2015,2016,2017]</a></li>
	      <li><a href="#">Communication Skills[2015,2016,2017] </a></li>
	</ul></li>

        <li id="sem2" onclick="test(this)"><a href="#">Semester 2<span class="arrow">&#9660;</span></a>
        	<ul id="sem2det" style="display:none">
        		<li><a href="#">Applied Mathematic[2015,2016,2017]</a></li>
		<li><a href="#">Applied Physics[2015,2016,2017]</a></li>
	    <li><a href="#">Electrical Science[2015,2016,2017]</a></li>
	    <li><a href="#">EVS[2015,2016,2017]</a></li>
	     <li><a href="#">EM[2015,2016,2017]</a></li>
	      <li><a href="#">Communication Skills[2015,2016,2017]</a></li>
	</ul></li>
		<li id="sem3" onclick="test(this)"><a href="#">Semester 3<span class="arrow">&#9660;</span></a>
			<ul id="sem3det" style="display:none">
        		<li><a href="#">Discrete Mathematics[2015,2016,2017]</a></li>
		<li><a href="#">Database & Management[2015,2016,2017]</a></li>
	    <li><a href="#">Data Structures[2015,2016,2017]</a></li>
	    <li><a href="#">Analog and Digital Electronics[2015,2016,2017]</a></li>
	     <li><a href="#">OOPS[2015,2016,2017]</a></li>
